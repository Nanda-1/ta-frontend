...
export default function OtpTtd() {
  const { setLoading, otpTandaTangan, otpModal } = useContext(MySuratKuasaContext);
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white ">
                ...
                <div className="relative p-6 px-12 flex-col text-blue font-roboto">
                  ...
                  <label className="text-md text-black block text-center py-10">
                    Saya {object.user_detail.name}, Saya Menyetujui Dokumen Ini
                  </label>
                  <OtpInput
                    inputStyle="otpInput"
                    value={kodeOtp}
