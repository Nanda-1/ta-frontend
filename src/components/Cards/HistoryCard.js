  ...
  return (
    <>
      <div className="relative break-words font-montserrat mb-8">
        <div className="text-blue text-bold pl-6 mt-6 mb-2 grid grid-cols-3 w-full">
          <div className="text-xl">Dokumen Terakhir</div>
          <div className="text-right col-span-2">
            <Link className="text-black text-sm pt-1" to={"/admin/dokumen"}>
              Lihat Semua
            </Link>
          </div>
        </div>
        <div
          className={
            "relative font-bold box-content px-3 py-5 history-shadow rounded-lg"
          }
        >
