...
const Step5r = (props) => {
  ...
  const sendLengkapiDiri = async () => {
    ...
    try {
      ...
      // swal({
      //   title: "Perhatian!",
      //   text: "Pastikan Anda mengisikan nama lengkap, alamat email dan nomor handphone yang sesuai. Karena data - data tersebut tidak dapat diubah dan akan digunakan sebagai alat autentikasi tanda tangan digital Anda.\n\nAgar proses approval oleh administrator 'dapat dilakukan, harap mengisi informasi yang sesuai dengan kartu identitas Anda",
      //   icon: "warning",
      // });
                        ...
                        <ul className="flex">
                          <li>
                            <button
                              type="button"
                              onClick={resetCanvas}
                              className="get-started justify-center text-black px-4 py-2 rounded-lg outline-none focus:outline-none mr-1 bg-white active:bg-blue-500 text-xs hover:shadow-lg ease-linear transition-all duration-150"
                            >
