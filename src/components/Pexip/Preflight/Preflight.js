...
export default function Preflight() {
  ...
  if(Cookies.get('dialURI') && Cookies.get('participantName')){
    Cookies.remove('dialURI')
  ...
  function connectCall() {
    setParticipantName(Cookies.get('nama'));
    // Set our Dial URI for other components to use
    setDialURI(dialURI.current.value);
    Cookies.set('dialURI', dialURI.current.value)
    ...
    <div className="preflightContainer">
      ...
      <div className="preflightContent">
        ...
        <div className="preflightContentBody z-10">
          <input type="text" value={Cookies.get('nama')} className='disabled' disabled />
        </div>
