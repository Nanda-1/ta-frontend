...
export default function Call() {
  ...
  useEffect(() => {
    ...
    pexRTC.makeCall("pexipdemo.com", 'meet.bob', Cookies.get('nama') );
  ...
  return (
    <div className="callContainer">
      <div className="callVideoContainer">
        ...
        <video ref={pexipVideoRef} autoPlay="autoplay" className="mx-auto"></video>
        {/* <video ref={pexipVideoRef1} autoPlay="autoplay"></video> */}
      </div>
