...
import LandingDropDown from "components/Dropdown/LandingDropDown";
// components
...
export default function NavbarLanding() {
  return (
    <>
      <nav
        className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between navbar-expand-lg bg-blue-4 shadow"
          ...
          >
            <ul className="flex flex-col font-manrope lg:flex-row list-none lg:ml-auto">
              <li className="flex items-center">
                <Link
                  to="/landing_page"
                  className="text-white text-sm leading-relaxed inline-block mr-6 py-2 whitespace-nowrap"
                >
                  Home
                </Link>
              </li>
