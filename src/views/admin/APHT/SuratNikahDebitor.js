              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img alt="surat_nikah" src={`data:image/png;base64,`+inputApht.surat_nikah_debitor} />
                    </span>
                    <button
                    type="button"
...
export default SuratNikahDebitor;