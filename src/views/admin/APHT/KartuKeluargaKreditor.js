...
const KartuKeluargaKreditor = props => {
  const { inputApht, setInputApht, setApht } = useContext(MyAphtcontext)
      ...
      const handleStartCaptureClick = async () => {
        ...
        let name = 'kartu_keluarga_kreditor'
              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img src={`data:image/png;base64,`+inputApht.kartu_keluarga_kreditor} alt="kk" />
                    </span>
                    <button
                    type="button"
...
export default KartuKeluargaKreditor;