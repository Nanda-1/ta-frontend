              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  <div className="relative w-full mb-6">
                    ...
                    >
                      Ambil Foto PBB Tahun Terakhir
                    </label>
                    <label className="text-xs">
                    Data SPPT (Surat Pemberitahuan Pajak Terhutang) PBB (Pihak Pertama). <br/>Foto Asli SPPT PBB Tahun Terakhir Untuk Otentikasi
                    </label>
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img src={`data:image/png;base64,`+inputApht.pbb_tahun_terakhir} alt="pbb" />
                    </span>
                    <button
                    type="button"
