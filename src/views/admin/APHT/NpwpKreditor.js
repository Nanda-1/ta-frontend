              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  <div className="relative w-full mb-6">
                    ...
                    Data NPWP (Pihak Kedua). <br/>Gunakan NPWP Asli
                    </label>
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img src={`data:image/png;base64,`+inputApht.npwp_kreditor} alt="npwp" />
                    </span>
                    <button
                    type="button"
