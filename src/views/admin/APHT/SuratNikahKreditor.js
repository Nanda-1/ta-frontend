...
const SuratNikahKreditor = props => {
              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img src={`data:image/png;base64,`+inputApht.surat_nikah_kreditor} alt="surat_nikah" />
                    </span>
                    <button
                    type="button"
...
export default SuratNikahKreditor;