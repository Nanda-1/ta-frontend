              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false?
                  <div className="relative w-full mb-6">
                    ...
                    >
                      Ambil Foto Surat Tanda Terima Setoran
                    </label>
                    <label className="text-xs">
                    Data STTS (Pihak Pertama). <br/>Foto Asli STTS (Surat Tanda Terima Setoran) Untuk Otentikasi
                    </label>
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <img src={`data:image/png;base64,`+inputApht.stts} alt="stts" />
                    </span>
                    <button
                    type="button"
