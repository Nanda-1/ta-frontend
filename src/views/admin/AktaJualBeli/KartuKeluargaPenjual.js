...
const KartuKeluargaPenjual = (props) => {
  ...
  const handleStartCaptureClick = async () => {
    ...
    let name = "kartu_keluarga_penjual";
  ...
  if (props.currentStep !== "kk_penjual") {
    return null;
  }
                ...
                {capturing === false ? (
                  <div className="relative w-full mb-6">
                    ...
                    <label className="text-xs">
                      Data Kartu Keluarga Penjual (Pihak Pertama). <br />
                    ...
                    <span className="flex mt-4 mb-1">
                      <img
                        src={
                          ...
                          inputAjb.kartu_keluarga_penjual
                        }
                        alt="kk"
                      />
                    </span>
...
export default KartuKeluargaPenjual;
