...
const AktaPendirianPenjual = (props) => {
  const { setAjb, inputAjb, setInputAjb, penjual, setPenjual } = useContext(MyAjbContext);
  ...
  if (penjual && props.currentStep === "akta_pendirian_penjual") {
    setPenjual(false);
    swal("Berhasil", "Berhasil membuat data penjual", "success");
  }

  if (props.currentStep !== "akta_pendirian_penjual") {
    return null;
  }
                      ...
                      >
                        <div className="h-auto">
                          ...
                          <input
                            ...
                            name="akta_pendirian_penjual"
                            // required={true}
                            // value={inputAjb.akta_pendirian_penjual}
                          />
                          <br />
...
export default AktaPendirianPenjual;
