...
const NpwpPenjual = (props) => {
  ...
  if (props.currentStep !== "npwp_penjual") {
    return null;
  }
                ...
                {capturing === false ? (
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <span className="flex mt-4 mb-1">
                      <img
                        src={`data:image/png;base64,` + inputAjb.npwp_penjual}
                        alt="npwp"
                      />
                    </span>
                    <button
