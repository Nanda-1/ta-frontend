                ...
                {capturing === false ? (
                  <div className="relative w-full mb-6">
                    ...
                    <label className="text-xs">
                      Data SPPT (Surat Pemberitahuan Pajak Terhutang) PBB (Pihak
                      Pertama). <br />
                      Foto Asli SPPT PBB Tahun Terakhir Untuk Otentikasi
                    </label>
                  ...
                  <div className="relative w-full mb-6">
                    ...
                    <span className="flex mt-4 mb-1">
                      <img
                        src={
                          `data:image/png;base64,` + inputAjb.pbb_tahun_terakhir
                        }
                        alt="pbb"
                      />
                    </span>
