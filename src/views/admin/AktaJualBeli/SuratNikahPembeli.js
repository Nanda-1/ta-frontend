...
const SuratNikahPembeli = (props) => {
  const { inputAjb, setInputAjb, setAjb, pembeli, setPembeli } = useContext(MyAjbContext);
  ...
  if (pembeli && props.currentStep === "surat_nikah_pembeli") {
    setPembeli(false);
    swal("Berhasil", "Berhasil membuat data pembeli", "success");
  }

  if (props.currentStep !== "surat_nikah_pembeli") {
    return null;
  }
              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false ? (
                  <div className="relative w-full mb-6">
                    ...
                    >
                      Ambil Foto Surat Nikah
                    </label>
                    <label className="text-xs">
                      Ambil Foto Surat Nikah <b>Asli</b>.
                    </label>
...
export default SuratNikahPembeli;
