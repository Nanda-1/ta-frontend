...
const KartuKeluargaPembeli = (props) => {
  const { inputAjb, setInputAjb, setAjb, pembeli, setPembeli } =
  ...
  const handleStartCaptureClick = async () => {
    ...
    let name = "kartu_keluarga_pembeli";
  ...
  if (pembeli && props.currentStep === "kk_pembeli") {
    setPembeli(false);
    swal("Berhasil", "Berhasil membuat data pembeli", "success");
  }

  if (props.currentStep !== "kk_pembeli") {
    return null;
  }
              ...
              <div className="rounded-tpx-6 text-darkgrey py-2 px-4 text-center">
                {capturing === false ? (
                  <div className="relative w-full mb-6">
                    ...
                    >
                      Ambil Foto Kartu Keluarga
                    </label>
                    <label className="text-xs">
                      Data Kartu Keluarga Penjual (Pihak Kedua). <br />
                      Gunakan Kartu Keluarga Asli
                    </label>
                    ...
                    <span className="flex mt-4 mb-1">
                      <img
                        src={
                          ...
                          inputAjb.kartu_keluarga_pembeli
                        }
                        alt="kk"
                      />
                    </span>
...
export default KartuKeluargaPembeli;
